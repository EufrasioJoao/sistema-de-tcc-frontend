...
type SidebarContextProps = {
  ...
  setSidebarMobileWidth: React.Dispatch<React.SetStateAction<string>>;
...
function SidebarProvider({
  ...
  const [sidebarWidth, setSidebarWidth] = React.useState("7rem");
  const [sidebarMobileWidth, setSidebarMobileWidth] = React.useState("18rem");
...
function Sidebar({
  ...
  const { isMobile, state, openMobile, setOpenMobile, sidebarMobileWidth } =
    useSidebar();
